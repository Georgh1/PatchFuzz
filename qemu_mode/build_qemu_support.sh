...
patch -p1 <../patches/ioctls.diff || exit 1

cp ../tcg.h ./tcg/tcg.h
cp ../tcg-target.inc.c ./tcg/i386/tcg-target.inc.c
cp ../exec-all.h ./include/exec/exec-all.h
cp ../translate-all.c ./accel/tcg/translate-all.c
